...
def person_cognition():
    ...
    while(True):
        ...
        #img_list = ["sample4.jpg", "sample1.jpg", "sample2.jpg"]
        img_list = ["sample1.jpg", "sample3.jpg", "sample2.jpg", "sample4.jpg", "sample5.jpg"]
        
        max_person = 0
        person_num = 0
        for i in range(3):
            #person_num1, img1 = person_detection(img_list[i], "none")
            #person_num2, img2 = person_detection(img_list[i], "filter")
            person_num1, img1 = person_detection(img_list[for_count % 5], "none")
            person_num2, img2 = person_detection(img_list[for_count % 5], "filter")
